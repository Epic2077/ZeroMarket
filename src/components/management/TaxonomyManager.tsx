...
import { TaxonomyCategory, taxonomyCategoryMeta } from "@/lib/supabase/taxonomy";
...
export default function TaxonomyManager() {
  ...
  return (
    <div className="grid grid-cols-1 gap-5 lg:grid-cols-4">
      <CategorySidebar active={active} onSelect={handleCategorySelect} getCount={getCount} />
      ...
      <div className="card-elevated p-5 lg:col-span-3">
        ...
        {isBrandView ? (
          <BrandAccordion
            ...
            onRenameModel={(oldVal, newVal) => handleRename(oldVal, newVal, "MODEL")}
          />
        ) : (
          <>
            {options.length === 0 ? (
